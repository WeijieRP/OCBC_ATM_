// src/modes/elderly/ElderlyApp.jsx
...
const [language, setLanguage] = useState(ELDERLY_PREFS.defaultLanguage);
...
useEffect(() => {
if (!languageLocked) {
    setLanguage(ELDERLY_PREFS.defaultLanguage || "EN");
}
}, [languageLocked]);
...
"atm-root",
"atm-root--light",
ELDERLY_PREFS.fontSize === "large"
    ? "atm-root--font-lg"
    : ELDERLY_PREFS.fontSize === "xlarge"
    ? "atm-root--font-xl"
    : "atm-root--font-md",
ELDERLY_PREFS.fontColour === "highContrast"
...
const onlyExit = buttons.length === 2;
